...
//	It arises when classes are aware of each other. If a class has the details information of another class,
//	there is strong coupling. In Java, we use private, protected, and public modifiers to display the visibility
//	level of a class, method, and field. You can use interfaces for the weaker coupling because there is no concrete 
//	implementation.
////
////Cohesion
////Cohesion refers to the level of a component which performs a single well-defined task.
//	A single well-defined task is done by a highly cohesive method. The weakly cohesive method will split the
//	task into separate parts. The java.io package is a highly cohesive package because it has I/O related classes
//	and interface. However, the java.util package is a weakly cohesive package because it has unrelated classes and 
//	interfaces.
////AD
////
////Association
...
//		(one to one), and a prime minister can have many ministers (one to many). 
